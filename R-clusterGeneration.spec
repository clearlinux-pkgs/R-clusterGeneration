...
Version  : 1.3.6
Release  : 22
URL      : https://cran.r-project.org/src/contrib/clusterGeneration_1.3.6.tar.gz
Source0  : https://cran.r-project.org/src/contrib/clusterGeneration_1.3.6.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606150648
